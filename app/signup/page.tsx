    ...
    <main className="relative min-h-screen bg-[#0a0a0a] flex items-center justify-center overflow-hidden px-4">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 0 1px rgba(234,120,30,.3), 0 0 40px rgba(234,120,30,.2)",
      ...
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle at 35% 35%, #f5a55a, #ea781e 55%, #7a3a0a)",
          boxShadow: "0 0 0 1px rgba(234,120,30,.25), 0 0 24px rgba(234,120,30,.18)",
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <div
              style={{
                ...
                boxShadow: "0 0 0 1px rgba(234,120,30,.4), 0 12px 32px rgba(234,120,30,.25)",
          ...
          {session ? (
            ...
            <div className="flex flex-col items-center">
              ...
              <p style={{ color: "#ea781e", marginTop: 6, fontSize: 15, fontFamily: "Georgia, serif" }}>
                {session.user?.name}
              </p>
              <p style={{ color: "rgba(245,240,232,.45)", fontSize: 13, marginTop: 2 }}>
                {session.user?.email}
              </p>
            ...
            <>
              ...
              >
                {[
                  { icon: <Users className="w-5 h-5" style={{ color: "#ea781e" }} />, label: "Rooms" },
                  { icon: <Brain className="w-5 h-5" style={{ color: "#ea781e" }} />, label: "Quiz" },
                  { icon: <Trophy className="w-5 h-5" style={{ color: "#ea781e" }} />, label: "Ranking" },
                ].map((f) => (
                  <div
                    key={f.label}
                    style={{
                  ...
                  >
                    {f.icon}
                    <span style={{ color: "rgba(245,240,232,.6)", fontSize: 12, fontFamily: "Georgia, serif" }}>
                      {f.label}
                    </span>
                  </div>
                ))}
              ...
              >
                <div style={{ flex: 1, height: "0.5px", background: "rgba(234,120,30,.15)" }} />
                <span style={{ fontSize: 11, color: "rgba(245,240,232,.3)", letterSpacing: ".08em" }}>
