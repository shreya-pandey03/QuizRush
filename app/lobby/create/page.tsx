...
export default function CreateLobbyPage() {
  ...
  async function createLobby() {
    ...
    try {
      ...
      const res = await fetch("/api/lobby/create", {
        ...
        body: JSON.stringify({ name, hostId: "host123" }),
      });
  ...
  return (
    ...
    >
      ...
      {/* ── Floating orbs ── */}
      <div className="fixed pointer-events-none" style={{ top: "18%", left: "5%", width: 80, height: 80, borderRadius: "50%", background: "radial-gradient(circle at 35% 35%, #f5a55a, #ea781e 55%, #7a3a0a)", boxShadow: "0 0 0 1px rgba(234,120,30,.3), 0 0 36px rgba(234,120,30,.18)", animation: "floatA 8s ease-in-out infinite", opacity: 0.45, zIndex: 0 }} />
      <div className="fixed pointer-events-none" style={{ top: "60%", right: "6%", width: 50, height: 50, borderRadius: "50%", background: "radial-gradient(circle at 35% 35%, #f5a55a, #ea781e 55%, #7a3a0a)", boxShadow: "0 0 0 1px rgba(234,120,30,.25), 0 0 20px rgba(234,120,30,.15)", animation: "floatB 10s ease-in-out infinite", opacity: 0.4, zIndex: 0 }} />
      <div className="fixed pointer-events-none" style={{ bottom: "20%", left: "10%", width: 28, height: 28, borderRadius: "50%", background: "#1a0a03", border: "1px solid rgba(234,120,30,.4)", animation: "floatC 6s ease-in-out infinite", opacity: 0.55, zIndex: 0 }} />
      <div className="fixed pointer-events-none" style={{ top: "10%", right: "13%", width: 18, height: 18, borderRadius: "50%", background: "#1a0a03", border: "1px solid rgba(234,120,30,.35)", animation: "floatA 7s ease-in-out infinite", opacity: 0.5, zIndex: 0 }} />
      ...
      <div className="fixed pointer-events-none" style={{ bottom: "8%", right: "4%", width: 65, height: 65, borderRadius: "50%", border: "0.5px solid rgba(234,120,30,.11)", animation: "spinRing 16s linear infinite reverse", zIndex: 0 }} />
      ...
      <div className="relative w-full max-w-md" style={{ zIndex: 10 }}>
        ...
        >
          ...
          <p
            style={{
              color: "rgba(245,240,232,.45)", fontSize: 14,
          ...
          {/* Divider */}
          <div style={{ height: "0.5px", background: "rgba(234,120,30,.15)", margin: "1.5rem 0" }} />
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
            {["Up to 50 players", "Real-time scoring", "Custom questions"].map((tag) => (
              <span
                key={tag}
                style={{
          ...
          <p
            style={{
              ...
              color: "rgba(245,240,232,.22)", marginTop: 14,
            }}
          >
