        ...
        >
          ...
          <button
            ...
            style={{
              ...
              padding: "14px 0",
              borderRadius: 12,
              background: starting ? "rgba(234,120,30,.2)" : "#ea781e",
              border: "none",
              color: starting ? "rgba(245,240,232,.3)" : "#fff",
              fontSize: 15,
              fontFamily: "Georgia, serif",
              ...
              justifyContent: "center",
              gap: 8,
              boxShadow: !starting ? "0 8px 24px rgba(234,120,30,.25)" : "none",
