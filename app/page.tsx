...
const IconBolt = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M13 3L4 14h7l-1 7 9-11h-7l1-7z"/></svg>
);
const IconUsers = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="7" r="4"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/><path d="M21 21v-2a4 4 0 0 0-3-3.85"/></svg>
);
const IconTrophy = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M8 21h8m-4-4v4M7 4H4a1 1 0 0 0-1 1v3a4 4 0 0 0 4 4h.5M17 4h3a1 1 0 0 1 1 1v3a4 4 0 0 1-4 4h-.5"/><path d="M6 4h12v7a6 6 0 0 1-12 0V4z"/></svg>
);
const IconClock = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
);
const IconCategory = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
);
const IconMobile = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="7" y="2" width="10" height="20" rx="2"/><circle cx="12" cy="18" r="1" fill="currentColor" stroke="none"/></svg>
);
const IconGamepad = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M6 12h4m-2-2v4"/><circle cx="17" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="19" cy="10" r="1" fill="currentColor" stroke="none"/><path d="M4 8h16l-1.5 9a2 2 0 0 1-2 1.5H7.5a2 2 0 0 1-2-1.5L4 8z"/><path d="M8 8V6a2 2 0 0 1 4 0v2"/></svg>
);
const IconPlay = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3" fill="currentColor" stroke="none"/></svg>
);
const IconFlame = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c0 6-6 8-6 14a6 6 0 0 0 12 0c0-6-6-8-6-14z"/><path d="M12 12c0 3-2 4-2 7a2 2 0 0 0 4 0c0-3-2-4-2-7z"/></svg>
);
const IconStar = () => (
...
// ─── Leaderboard data ─────────────────────────────────────────────────────────
const LEADERS = [
  { rank: 1, initials: "VK", name: "Virat",    score: "3,180", pct: 100, color: "#FAC775", bg: "rgba(250,199,117,.15)", tier: "gold"   },
  { rank: 2, initials: "ST", name: "Sachin",   score: "2,840", pct: 89,  color: "#B4B2A9", bg: "rgba(180,178,169,.1)",  tier: "silver" },
  { rank: 3, initials: "SI", name: "Shreyas",  score: "2,390", pct: 75,  color: "#EF9F27", bg: "rgba(186,117,23,.12)", tier: "bronze" },
  { rank: 4, initials: "AB", name: "Abhishake",score: "1,820", pct: 57,  color: "rgba(234,120,30,.7)", bg: "rgba(234,120,30,.08)", tier: "" },
  { rank: 5, initials: "YO", name: "You (Host)",score: "980",  pct: 31,  color: "rgba(245,240,232,.4)", bg: "rgba(245,240,232,.05)", tier: "" },
];
...
const FEATURES = [
  { icon: <IconBolt />,     title: "Real-time battles",   desc: "Every answer syncs instantly. See your opponents move in live time — milliseconds matter." },
  { icon: <IconUsers />,    title: "Multiplayer rooms",   desc: "Create private rooms for friends or jump into a public lobby with up to 50 players." },
  { icon: <IconTrophy />,   title: "Live leaderboard",    desc: "Rankings update after every question. Climb from Bronze to Diamond across weekly seasons." },
  { icon: <IconClock />,    title: "Speed scoring",       desc: "Answer faster, score higher. The first correct response gets a speed bonus multiplier." },
  { icon: <IconCategory />, title: "30+ categories",      desc: "Sports, science, Bollywood, history, IPL, tech — new question packs drop every week." },
  { icon: <IconMobile />,   title: "Play anywhere",       desc: "Fully responsive — phone, tablet, desktop. Jump in from anywhere in seconds." },
];
      ...
      <div className="qr-root">
        ...
        <div className="qr-preview">
          <div className="qr-preview-hdr">
            ...
            <div className="qr-pdot" style={{ background: "rgba(245,240,232,.2)" }} />
            <div className="qr-pdot" style={{ background: "rgba(245,240,232,.2)" }} />
            <span style={{ marginLeft: 4 }}>Science &amp; Tech room — 24 players</span>
            <span style={{ marginLeft: "auto", color: "#ea781e", fontSize: 10, letterSpacing: ".1em" }}>
              ● LIVE
            </span>
          </div>
          <div className="qr-preview-body">
            <div className="qr-prog-row">
              <span style={{ fontSize: 11, color: "rgba(245,240,232,.4)" }}>Q 3 / 10</span>
              <div className="qr-prog-track">
                <div className="qr-prog-fill" />
              </div>
              <div className="qr-timer" style={timerDanger ? { color: "#F09595" } : {}}>
                <IconClock /> {timer}s
              </div>
            </div>
            <div className="qr-q-card">
              <div className="qr-q-label">Science &amp; Tech</div>
              <div className="qr-q-text">What does HTTP stand for in web technology?</div>
            </div>
        ...
        <section className="qr-cta-section">
          ...
          <p>Join thousands of players competing right now — no download needed.</p>
          <Link href="/signup" className="qr-btn-primary" style={{ fontSize: 15, padding: "15px 38px" }}>
